...
const BillsPage = () => {
  ...
  const getAllBills = async () => {
    try {
      ...
      const { data } = await axios.get(`https://dnsbackend.azurewebsites.net/api/bills/get-bills`);
      setBillsData(data);
        ...
        >
          ...
          <div id="invoice-POS" ref={componentRef}>
            <center id="top">
              <div className="logo" />
              <div className="info">
                <h2>Quick Prism Restaurant</h2>
                <p> Contact : 1234567890 | Siliguri West Bengal</p>
              </div>
              {/*End Info*/}
            </center>
            {/*End InvoiceTop*/}
